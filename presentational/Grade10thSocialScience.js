...
class Grade10thSocialScience extends React.Component{
render(){
    return(
        <ScrollView >
            <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:hp('4%')}}  >
                <View style={{marginLeft:hp('3%'),marginTop:hp('3%')}} >
                    ...
                    <TouchableHighlight
                     style={{marginTop:hp('1%'),borderRadius:20}}
                      onPress = {()=>this.props.navigation.navigate('SocialScience10th')}
                ...
                <View style={{marginRight:hp('3%')}} >
                    <Image source={{uri: 'https://static1.squarespace.com/static/57ed94f3b8a79b1f99f831aa/589e0833d2b85720b6c3db95/5c8ea4bd6e9a7f537d3efa81/1554308102334/10thSocialScience02-2017-cover.png?format=300w'}}
...
export default Grade10thSocialScience ;