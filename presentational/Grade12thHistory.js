...
class  Grade12thHistory extends React.Component{
render(){
    return(
        <ScrollView >
            <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:hp('4%')}}  >
                <View style={{marginLeft:hp('3%'),marginTop:hp('3%')}} >
                    ...
                    <TouchableHighlight
                      ...
                      onPress = {()=>this.props.navigation.navigate('History12th')}
                ...
                <View style={{marginRight:hp('3%')}} >
                    <Image source={{uri:'https://static1.squarespace.com/static/57ed94f3b8a79b1f99f831aa/589e0833d2b85720b6c3db95/5a4a7fbeec212ddd0805a802/1514844730180/2+PUC+history+Textbook-1.jpg?format=300w'}}
...
export default  Grade12thHistory ;