...
class  Grade9thEconomics  extends React.Component{
render(){
    return(
        <ScrollView >
            <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:hp('4%')}}  >
                ...
                <View style={{marginRight:hp('3%')}} >
                    <Image source={{uri: 'https://static1.squarespace.com/static/57ed94f3b8a79b1f99f831aa/589e0833d2b85720b6c3db95/5ca4da636e9a7f5e6c5b7ba4/1554307835884/Screenshot+2019-04-03+at+16.41.34.png?format=300w'}}
...
export default Grade9thEconomics ;