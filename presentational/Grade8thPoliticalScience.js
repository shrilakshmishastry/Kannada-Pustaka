...
class  Grade8thPoliticalScience extends React.Component{
render(){
    return(
        <ScrollView >
            <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:hp('4%')}}  >
                ...
                <View style={{marginRight:hp('3%')}} >
                    <Image source={{uri:'https://static1.squarespace.com/static/57ed94f3b8a79b1f99f831aa/589e0833d2b85720b6c3db95/5a4a9ff653450a63fe8313fc/1514844359654/8thpolitical-sc.jpg?format=300w'}}
...
export default Grade8thPoliticalScience;